package codecademy.java.learnarrays.arraysone;
...
public class ArraysOne {
    ...
    public ArraysOne(String[] initialArticles, int[] initialViews, double[] initialRatings){
    ...
    public static void main(String[] args){
        ...
        ArraysOne robotTimes = new ArraysOne(robotArticles, robotViewers, robotRatings);
